...
public record FreeClassBuilderImpl(
  ...
  public @NotNull FreeDecl.Clazz build() {
    return new FreeDecl.Clazz(metadata, className, superclass, members.freeze());
  }
  ...
  public void buildNestedClass(
    ...
    var classBuilder = new FreeClassBuilderImpl(compiledAya, className, superclass, FreezableMutableList.create());
  ...
  public @NotNull MethodRef buildMethod(
    ...
    var ref = new MethodRef.Default(this.className, name, returnType, paramTypes, false);
  ...
  public @NotNull MethodRef buildConstructor(
    ...
    var ref = FreeClassBuilder.makeConstructorRef(this.className, paramTypes);
    buildMethod(ref, builder);
    return ref;
  }
  ...
  public @NotNull FieldRef buildConstantField(
    ...
    var ref = new FieldRef.Default(this.className, returnType, name);
