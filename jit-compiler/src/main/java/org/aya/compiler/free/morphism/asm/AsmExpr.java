...
public record AsmExpr(@NotNull ClassDesc type,
                      @NotNull Consumer<AsmCodeBuilder> cont) implements FreeJavaExpr, Consumer<AsmCodeBuilder> {
  ...
  @Override
  public void accept(AsmCodeBuilder builder) {
    cont.accept(builder);
  }
}
