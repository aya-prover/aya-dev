...
public class SubstTest {
  ...
  public void unrelatedSubst() {
    ...
    assertTrue(term instanceof AppTerm);
    assertEquals(term, term.subst(new TermSubst(() -> "lambda", new UnivTerm(UnivTerm.SET0))));
  }
  ...
  public void relatedSubst() {
    ...
    assertTrue(term instanceof AppTerm);
    assertNotEquals(term, term.subst(new TermSubst(refs.get("beta"), new UnivTerm(UnivTerm.SET0))));
  }
}
