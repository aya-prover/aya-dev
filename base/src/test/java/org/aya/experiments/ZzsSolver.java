...
public class ZzsSolver {
  ...
  public static void main(String[] args) throws UnsatException {
    var res = new ZzsSolver().solve(List.of(
      new Equation(Ord.Eq, new Max(List.of(new Reference(new Var("Verb.u", true), 0))), new Max(List.of(new Reference(new Var("u", false), 0)))),
      new Equation(Ord.Eq, new Max(List.of(new Reference(new Var("Verb.v", true), 0))), new Max(List.of(new Reference(new Var("u", false), 0), new Reference(new Var("v", false), 0)))),
      new Equation(Ord.Lt, new Max(List.of(new Reference(new Var("u", false), 0))), new Max(List.of(new Reference(new Var("Verb.u", true), 0)))),
      ...
      new Equation(Ord.Lt, new Max(List.of(new Reference(new Var("Event.u", true), 0))), new Max(List.of(new Reference(new Var("Verb.v", true), 0)))),
      new Equation(Ord.Lt, new Max(List.of(new Reference(new Var("Event.u", true), 0))), new Max(List.of(new Reference(new Var("u", false), 0)))),
      new Equation(Ord.Lt, new Max(List.of(new Reference(new Var("u", false), 0), new Reference(new Var("v", false), 0))), new Max(List.of(new Reference(new Var("Verb.v", true), 0)))),
      new Equation(Ord.Lt, new Max(List.of(new Reference(new Var("Event.u", true), 0))), new Max(List.of(new Reference(new Var("Verb.u", true), 0)))),
      new Equation(Ord.Lt, new Max(List.of(new Reference(new Var("Verb.v", true), 0))), new Max(List.of(new Reference(new Var("Verb.v", true), 0))))));
