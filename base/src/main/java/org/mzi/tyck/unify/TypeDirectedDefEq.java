 ...
 * Instead, invoke {@link TypeDirectedDefEq#compare(Term, Term, Term)} to do so.
 */
public final class TypeDirectedDefEq implements Term.BiVisitor<@NotNull Term, @NotNull Term, @NotNull Boolean> {
  ...
  private final @NotNull TypedDefEq termDirectedDefeq;

  public TypeDirectedDefEq(
    @NotNull Function<@NotNull TypeDirectedDefEq, @NotNull TypedDefEq> createTypedDefEq,
