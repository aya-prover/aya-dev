 ...
 * @author ice1000
 */
public sealed interface Term extends AyaDocile permits CallTerm, ElimTerm, ErrorTerm, FormTerm, FormTerm.Interval, FormTerm.Left, FormTerm.Right, IntroTerm, RefTerm, RefTerm.Field, RefTerm.MetaPat {
