...
/**
 * core data definition, corresponding to {@link TopTeleDecl.DataDecl}
 *
 * @author kiva
 */
public final class DataDef extends UserDef.Type {
  public final @NotNull DefVar<DataDef, TopTeleDecl.DataDecl> ref;
  public final @NotNull ImmutableSeq<CtorDef> body;

  public DataDef(
    @NotNull DefVar<DataDef, TopTeleDecl.DataDecl> ref, @NotNull ImmutableSeq<Term.Param> telescope,
  ...
  public static @NotNull DefVar<DataDef, TopTeleDecl.DataDecl> fromCtor(@NotNull DefVar<CtorDef, TopTeleDecl.DataCtor> conHead) {
  ...
  public record CtorTelescopes(
    ...
    public @NotNull CallTerm.Con toConCall(DefVar<CtorDef, TopTeleDecl.DataCtor> conVar) {
