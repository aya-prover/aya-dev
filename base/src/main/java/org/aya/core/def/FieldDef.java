...
public final class FieldDef extends SubLevelDef {
  public final @NotNull DefVar<StructDef, TelescopicDecl.StructDecl> structRef;
  public final @NotNull DefVar<FieldDef, TelescopicDecl.StructField> ref;
  public final @NotNull Option<Term> body;

  public FieldDef(
          @NotNull DefVar<StructDef, TelescopicDecl.StructDecl> structRef, @NotNull DefVar<FieldDef, TelescopicDecl.StructField> ref,
  ...
  public @NotNull DefVar<FieldDef, TelescopicDecl.StructField> ref() {
    return ref;
  }
}
