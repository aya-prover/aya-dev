...
public final class PrimDef extends TopLevelDef {
  public PrimDef(
    @NotNull DefVar<@NotNull PrimDef, TelescopicDecl.@NotNull PrimDecl> ref,
  ...
  public PrimDef(@NotNull DefVar<@NotNull PrimDef, TelescopicDecl.@NotNull PrimDecl> ref, @NotNull Term result, @NotNull ID name) {
  ...
  record PrimSeed(
    ...
    @NotNull Function<@NotNull DefVar<PrimDef, TelescopicDecl.PrimDecl>, @NotNull PrimDef> supplier,
    @NotNull ImmutableSeq<@NotNull ID> dependency
  ) {
    public @NotNull PrimDef supply(@NotNull DefVar<PrimDef, TelescopicDecl.PrimDecl> ref) {
  ...
  public static class Factory {
    ...
    public @NotNull PrimDef factory(@NotNull ID name, @NotNull DefVar<PrimDef, TelescopicDecl.PrimDecl> ref) {
      assert !have(name);
    ...
    public @NotNull PrimDef getOrCreate(@NotNull ID name, @NotNull DefVar<PrimDef, TelescopicDecl.PrimDecl> ref) {
  ...
  public final @NotNull DefVar<@NotNull PrimDef, TelescopicDecl.PrimDecl> ref;
  public final @NotNull ID id;

  public @NotNull DefVar<@NotNull PrimDef, TelescopicDecl.PrimDecl> ref() {
    return ref;
  }
}
