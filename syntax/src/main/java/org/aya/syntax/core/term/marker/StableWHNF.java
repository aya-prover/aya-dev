...
public sealed interface StableWHNF extends Term
  permits ClassCastTerm, ErrorTerm, LamTerm, NewTerm, DepTypeTerm, SigmaTerm, SortTerm, TupTerm, ClassCall, DataCall, IntegerTerm, ListTerm, StringTerm, DimTerm, EqTerm {
}
