...
public sealed interface StableWHNF extends Term
  permits ClassCastTerm, DepTypeTerm, ErrorTerm, LamTerm, NewTerm, SortTerm, TupTerm, ClassCall, DataCall, IntegerTerm, ListTerm, StringTerm, DimTerm, EqTerm, PartialTerm, DisjCofNF, EqCofTerm {
}
