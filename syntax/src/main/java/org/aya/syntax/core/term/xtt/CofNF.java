...
public interface CofNF {
  ...
  static @NotNull Conj and(@NotNull OrVar<Conj> lhs, @NotNull OrVar<Conj> rhs) {
    return switch (lhs) {
  ...
  // compute a and b
  static @NotNull Disj and(@NotNull Disj a, @NotNull Disj b) {
    ...
    return new Disj(ret.toImmutableArray());
  }
